...
import ListAccumulatorLimitSetComponent from './components/ListAccumulatorLimitSetComponent';
import CreateAccumulatorLimitSetComponent from './components/CreateAccumulatorLimitSetComponent';
import UpdateAccumulatorLimitSetComponent from './components/UpdateAccumulatorLimitSetComponent';
import ViewAccumulatorLimitSetComponent from './components/ViewAccumulatorLimitSetComponent';
import ListAccumulatorResetComponent from './components/ListAccumulatorResetComponent';
import CreateAccumulatorResetComponent from './components/CreateAccumulatorResetComponent';
import UpdateAccumulatorResetComponent from './components/UpdateAccumulatorResetComponent';
import ViewAccumulatorResetComponent from './components/ViewAccumulatorResetComponent';
...
import ListAnalogLimitSetComponent from './components/ListAnalogLimitSetComponent';
import CreateAnalogLimitSetComponent from './components/CreateAnalogLimitSetComponent';
import UpdateAnalogLimitSetComponent from './components/UpdateAnalogLimitSetComponent';
import ViewAnalogLimitSetComponent from './components/ViewAnalogLimitSetComponent';
...
import ListAsynchronousMachineDynamicsComponent from './components/ListAsynchronousMachineDynamicsComponent';
import CreateAsynchronousMachineDynamicsComponent from './components/CreateAsynchronousMachineDynamicsComponent';
import UpdateAsynchronousMachineDynamicsComponent from './components/UpdateAsynchronousMachineDynamicsComponent';
import ViewAsynchronousMachineDynamicsComponent from './components/ViewAsynchronousMachineDynamicsComponent';
...
import ListBayComponent from './components/ListBayComponent';
import CreateBayComponent from './components/CreateBayComponent';
import UpdateBayComponent from './components/UpdateBayComponent';
import ViewBayComponent from './components/ViewBayComponent';
...
import ListConformLoadComponent from './components/ListConformLoadComponent';
import CreateConformLoadComponent from './components/CreateConformLoadComponent';
import UpdateConformLoadComponent from './components/UpdateConformLoadComponent';
import ViewConformLoadComponent from './components/ViewConformLoadComponent';
import ListConformLoadScheduleComponent from './components/ListConformLoadScheduleComponent';
import CreateConformLoadScheduleComponent from './components/CreateConformLoadScheduleComponent';
import UpdateConformLoadScheduleComponent from './components/UpdateConformLoadScheduleComponent';
import ViewConformLoadScheduleComponent from './components/ViewConformLoadScheduleComponent';
...
import ListControlAreaGeneratingUnitComponent from './components/ListControlAreaGeneratingUnitComponent';
import CreateControlAreaGeneratingUnitComponent from './components/CreateControlAreaGeneratingUnitComponent';
import UpdateControlAreaGeneratingUnitComponent from './components/UpdateControlAreaGeneratingUnitComponent';
import ViewControlAreaGeneratingUnitComponent from './components/ViewControlAreaGeneratingUnitComponent';
...
import ListDCBaseTerminalComponent from './components/ListDCBaseTerminalComponent';
import CreateDCBaseTerminalComponent from './components/CreateDCBaseTerminalComponent';
import UpdateDCBaseTerminalComponent from './components/UpdateDCBaseTerminalComponent';
import ViewDCBaseTerminalComponent from './components/ViewDCBaseTerminalComponent';
...
import ListDCLineComponent from './components/ListDCLineComponent';
import CreateDCLineComponent from './components/CreateDCLineComponent';
import UpdateDCLineComponent from './components/UpdateDCLineComponent';
import ViewDCLineComponent from './components/ViewDCLineComponent';
...
import ListDCNodeComponent from './components/ListDCNodeComponent';
import CreateDCNodeComponent from './components/CreateDCNodeComponent';
import UpdateDCNodeComponent from './components/UpdateDCNodeComponent';
import ViewDCNodeComponent from './components/ViewDCNodeComponent';
...
import ListDCTerminalComponent from './components/ListDCTerminalComponent';
import CreateDCTerminalComponent from './components/CreateDCTerminalComponent';
import UpdateDCTerminalComponent from './components/UpdateDCTerminalComponent';
import ViewDCTerminalComponent from './components/ViewDCTerminalComponent';
import ListDCTopologicalIslandComponent from './components/ListDCTopologicalIslandComponent';
import CreateDCTopologicalIslandComponent from './components/CreateDCTopologicalIslandComponent';
import UpdateDCTopologicalIslandComponent from './components/UpdateDCTopologicalIslandComponent';
import ViewDCTopologicalIslandComponent from './components/ViewDCTopologicalIslandComponent';
import ListDCTopologicalNodeComponent from './components/ListDCTopologicalNodeComponent';
import CreateDCTopologicalNodeComponent from './components/CreateDCTopologicalNodeComponent';
import UpdateDCTopologicalNodeComponent from './components/UpdateDCTopologicalNodeComponent';
import ViewDCTopologicalNodeComponent from './components/ViewDCTopologicalNodeComponent';
...
import ListDiscontinuousExcitationControlDynamicsComponent from './components/ListDiscontinuousExcitationControlDynamicsComponent';
import CreateDiscontinuousExcitationControlDynamicsComponent from './components/CreateDiscontinuousExcitationControlDynamicsComponent';
import UpdateDiscontinuousExcitationControlDynamicsComponent from './components/UpdateDiscontinuousExcitationControlDynamicsComponent';
import ViewDiscontinuousExcitationControlDynamicsComponent from './components/ViewDiscontinuousExcitationControlDynamicsComponent';
...
import ListDiscreteComponent from './components/ListDiscreteComponent';
import CreateDiscreteComponent from './components/CreateDiscreteComponent';
import UpdateDiscreteComponent from './components/UpdateDiscreteComponent';
import ViewDiscreteComponent from './components/ViewDiscreteComponent';
...
import ListEnergySourceComponent from './components/ListEnergySourceComponent';
import CreateEnergySourceComponent from './components/CreateEnergySourceComponent';
import UpdateEnergySourceComponent from './components/UpdateEnergySourceComponent';
import ViewEnergySourceComponent from './components/ViewEnergySourceComponent';
...
import ListEquivalentEquipmentComponent from './components/ListEquivalentEquipmentComponent';
import CreateEquivalentEquipmentComponent from './components/CreateEquivalentEquipmentComponent';
import UpdateEquivalentEquipmentComponent from './components/UpdateEquivalentEquipmentComponent';
import ViewEquivalentEquipmentComponent from './components/ViewEquivalentEquipmentComponent';
...
import ListExcitationSystemDynamicsComponent from './components/ListExcitationSystemDynamicsComponent';
import CreateExcitationSystemDynamicsComponent from './components/CreateExcitationSystemDynamicsComponent';
import UpdateExcitationSystemDynamicsComponent from './components/UpdateExcitationSystemDynamicsComponent';
import ViewExcitationSystemDynamicsComponent from './components/ViewExcitationSystemDynamicsComponent';
...
import ListGrossToNetActivePowerCurveComponent from './components/ListGrossToNetActivePowerCurveComponent';
import CreateGrossToNetActivePowerCurveComponent from './components/CreateGrossToNetActivePowerCurveComponent';
import UpdateGrossToNetActivePowerCurveComponent from './components/UpdateGrossToNetActivePowerCurveComponent';
import ViewGrossToNetActivePowerCurveComponent from './components/ViewGrossToNetActivePowerCurveComponent';
...
import ListHydroPumpComponent from './components/ListHydroPumpComponent';
import CreateHydroPumpComponent from './components/CreateHydroPumpComponent';
import UpdateHydroPumpComponent from './components/UpdateHydroPumpComponent';
import ViewHydroPumpComponent from './components/ViewHydroPumpComponent';
...
import ListLineComponent from './components/ListLineComponent';
import CreateLineComponent from './components/CreateLineComponent';
import UpdateLineComponent from './components/UpdateLineComponent';
import ViewLineComponent from './components/ViewLineComponent';
...
import ListLoadGroupComponent from './components/ListLoadGroupComponent';
import CreateLoadGroupComponent from './components/CreateLoadGroupComponent';
import UpdateLoadGroupComponent from './components/UpdateLoadGroupComponent';
import ViewLoadGroupComponent from './components/ViewLoadGroupComponent';
...
import ListMeasurementValueQualityComponent from './components/ListMeasurementValueQualityComponent';
import CreateMeasurementValueQualityComponent from './components/CreateMeasurementValueQualityComponent';
import UpdateMeasurementValueQualityComponent from './components/UpdateMeasurementValueQualityComponent';
import ViewMeasurementValueQualityComponent from './components/ViewMeasurementValueQualityComponent';
...
import ListMechanicalLoadDynamicsComponent from './components/ListMechanicalLoadDynamicsComponent';
import CreateMechanicalLoadDynamicsComponent from './components/CreateMechanicalLoadDynamicsComponent';
import UpdateMechanicalLoadDynamicsComponent from './components/UpdateMechanicalLoadDynamicsComponent';
import ViewMechanicalLoadDynamicsComponent from './components/ViewMechanicalLoadDynamicsComponent';
...
import ListNonConformLoadComponent from './components/ListNonConformLoadComponent';
import CreateNonConformLoadComponent from './components/CreateNonConformLoadComponent';
import UpdateNonConformLoadComponent from './components/UpdateNonConformLoadComponent';
import ViewNonConformLoadComponent from './components/ViewNonConformLoadComponent';
import ListNonConformLoadScheduleComponent from './components/ListNonConformLoadScheduleComponent';
import CreateNonConformLoadScheduleComponent from './components/CreateNonConformLoadScheduleComponent';
import UpdateNonConformLoadScheduleComponent from './components/UpdateNonConformLoadScheduleComponent';
import ViewNonConformLoadScheduleComponent from './components/ViewNonConformLoadScheduleComponent';
...
import ListOperationalLimitComponent from './components/ListOperationalLimitComponent';
import CreateOperationalLimitComponent from './components/CreateOperationalLimitComponent';
import UpdateOperationalLimitComponent from './components/UpdateOperationalLimitComponent';
import ViewOperationalLimitComponent from './components/ViewOperationalLimitComponent';
import ListOperationalLimitSetComponent from './components/ListOperationalLimitSetComponent';
import CreateOperationalLimitSetComponent from './components/CreateOperationalLimitSetComponent';
import UpdateOperationalLimitSetComponent from './components/UpdateOperationalLimitSetComponent';
import ViewOperationalLimitSetComponent from './components/ViewOperationalLimitSetComponent';
...
import ListOverexcitationLimiterDynamicsComponent from './components/ListOverexcitationLimiterDynamicsComponent';
import CreateOverexcitationLimiterDynamicsComponent from './components/CreateOverexcitationLimiterDynamicsComponent';
import UpdateOverexcitationLimiterDynamicsComponent from './components/UpdateOverexcitationLimiterDynamicsComponent';
import ViewOverexcitationLimiterDynamicsComponent from './components/ViewOverexcitationLimiterDynamicsComponent';
...
import ListPFVArControllerType1DynamicsComponent from './components/ListPFVArControllerType1DynamicsComponent';
import CreatePFVArControllerType1DynamicsComponent from './components/CreatePFVArControllerType1DynamicsComponent';
import UpdatePFVArControllerType1DynamicsComponent from './components/UpdatePFVArControllerType1DynamicsComponent';
import ViewPFVArControllerType1DynamicsComponent from './components/ViewPFVArControllerType1DynamicsComponent';
...
import ListPFVArControllerType2DynamicsComponent from './components/ListPFVArControllerType2DynamicsComponent';
import CreatePFVArControllerType2DynamicsComponent from './components/CreatePFVArControllerType2DynamicsComponent';
import UpdatePFVArControllerType2DynamicsComponent from './components/UpdatePFVArControllerType2DynamicsComponent';
import ViewPFVArControllerType2DynamicsComponent from './components/ViewPFVArControllerType2DynamicsComponent';
...
import ListPhaseTapChangerComponent from './components/ListPhaseTapChangerComponent';
import CreatePhaseTapChangerComponent from './components/CreatePhaseTapChangerComponent';
import UpdatePhaseTapChangerComponent from './components/UpdatePhaseTapChangerComponent';
import ViewPhaseTapChangerComponent from './components/ViewPhaseTapChangerComponent';
...
import ListPhaseTapChangerTabularComponent from './components/ListPhaseTapChangerTabularComponent';
import CreatePhaseTapChangerTabularComponent from './components/CreatePhaseTapChangerTabularComponent';
import UpdatePhaseTapChangerTabularComponent from './components/UpdatePhaseTapChangerTabularComponent';
import ViewPhaseTapChangerTabularComponent from './components/ViewPhaseTapChangerTabularComponent';
...
import ListPowerSystemStabilizerDynamicsComponent from './components/ListPowerSystemStabilizerDynamicsComponent';
import CreatePowerSystemStabilizerDynamicsComponent from './components/CreatePowerSystemStabilizerDynamicsComponent';
import UpdatePowerSystemStabilizerDynamicsComponent from './components/UpdatePowerSystemStabilizerDynamicsComponent';
import ViewPowerSystemStabilizerDynamicsComponent from './components/ViewPowerSystemStabilizerDynamicsComponent';
...
import ListRaiseLowerCommandComponent from './components/ListRaiseLowerCommandComponent';
import CreateRaiseLowerCommandComponent from './components/CreateRaiseLowerCommandComponent';
import UpdateRaiseLowerCommandComponent from './components/UpdateRaiseLowerCommandComponent';
import ViewRaiseLowerCommandComponent from './components/ViewRaiseLowerCommandComponent';
...
import ListRatioTapChangerTablePointComponent from './components/ListRatioTapChangerTablePointComponent';
import CreateRatioTapChangerTablePointComponent from './components/CreateRatioTapChangerTablePointComponent';
import UpdateRatioTapChangerTablePointComponent from './components/UpdateRatioTapChangerTablePointComponent';
import ViewRatioTapChangerTablePointComponent from './components/ViewRatioTapChangerTablePointComponent';
...
import ListRegulatingCondEqComponent from './components/ListRegulatingCondEqComponent';
import CreateRegulatingCondEqComponent from './components/CreateRegulatingCondEqComponent';
import UpdateRegulatingCondEqComponent from './components/UpdateRegulatingCondEqComponent';
import ViewRegulatingCondEqComponent from './components/ViewRegulatingCondEqComponent';
...
import ListRegulationScheduleComponent from './components/ListRegulationScheduleComponent';
import CreateRegulationScheduleComponent from './components/CreateRegulationScheduleComponent';
import UpdateRegulationScheduleComponent from './components/UpdateRegulationScheduleComponent';
import ViewRegulationScheduleComponent from './components/ViewRegulationScheduleComponent';
...
import ListSeasonDayTypeScheduleComponent from './components/ListSeasonDayTypeScheduleComponent';
import CreateSeasonDayTypeScheduleComponent from './components/CreateSeasonDayTypeScheduleComponent';
import UpdateSeasonDayTypeScheduleComponent from './components/UpdateSeasonDayTypeScheduleComponent';
import ViewSeasonDayTypeScheduleComponent from './components/ViewSeasonDayTypeScheduleComponent';
...
import ListSubGeographicalRegionComponent from './components/ListSubGeographicalRegionComponent';
import CreateSubGeographicalRegionComponent from './components/CreateSubGeographicalRegionComponent';
import UpdateSubGeographicalRegionComponent from './components/UpdateSubGeographicalRegionComponent';
import ViewSubGeographicalRegionComponent from './components/ViewSubGeographicalRegionComponent';
import ListSubLoadAreaComponent from './components/ListSubLoadAreaComponent';
import CreateSubLoadAreaComponent from './components/CreateSubLoadAreaComponent';
import UpdateSubLoadAreaComponent from './components/UpdateSubLoadAreaComponent';
import ViewSubLoadAreaComponent from './components/ViewSubLoadAreaComponent';
import ListSubstationComponent from './components/ListSubstationComponent';
import CreateSubstationComponent from './components/CreateSubstationComponent';
import UpdateSubstationComponent from './components/UpdateSubstationComponent';
import ViewSubstationComponent from './components/ViewSubstationComponent';
...
import ListSwitchScheduleComponent from './components/ListSwitchScheduleComponent';
import CreateSwitchScheduleComponent from './components/CreateSwitchScheduleComponent';
import UpdateSwitchScheduleComponent from './components/UpdateSwitchScheduleComponent';
import ViewSwitchScheduleComponent from './components/ViewSwitchScheduleComponent';
...
import ListSynchronousMachineDynamicsComponent from './components/ListSynchronousMachineDynamicsComponent';
import CreateSynchronousMachineDynamicsComponent from './components/CreateSynchronousMachineDynamicsComponent';
import UpdateSynchronousMachineDynamicsComponent from './components/UpdateSynchronousMachineDynamicsComponent';
import ViewSynchronousMachineDynamicsComponent from './components/ViewSynchronousMachineDynamicsComponent';
...
import ListTapScheduleComponent from './components/ListTapScheduleComponent';
import CreateTapScheduleComponent from './components/CreateTapScheduleComponent';
import UpdateTapScheduleComponent from './components/UpdateTapScheduleComponent';
import ViewTapScheduleComponent from './components/ViewTapScheduleComponent';
...
import UpdateTerminalComponent from './components/UpdateTerminalComponent';
...
import ListTopologicalIslandComponent from './components/ListTopologicalIslandComponent';
import CreateTopologicalIslandComponent from './components/CreateTopologicalIslandComponent';
import UpdateTopologicalIslandComponent from './components/UpdateTopologicalIslandComponent';
import ViewTopologicalIslandComponent from './components/ViewTopologicalIslandComponent';
...
import ListTurbineGovernorDynamicsComponent from './components/ListTurbineGovernorDynamicsComponent';
import CreateTurbineGovernorDynamicsComponent from './components/CreateTurbineGovernorDynamicsComponent';
import UpdateTurbineGovernorDynamicsComponent from './components/UpdateTurbineGovernorDynamicsComponent';
import ViewTurbineGovernorDynamicsComponent from './components/ViewTurbineGovernorDynamicsComponent';
...
import ListTurbineLoadControllerDynamicsComponent from './components/ListTurbineLoadControllerDynamicsComponent';
import CreateTurbineLoadControllerDynamicsComponent from './components/CreateTurbineLoadControllerDynamicsComponent';
import UpdateTurbineLoadControllerDynamicsComponent from './components/UpdateTurbineLoadControllerDynamicsComponent';
import ViewTurbineLoadControllerDynamicsComponent from './components/ViewTurbineLoadControllerDynamicsComponent';
...
import ListUnderexcitationLimiterDynamicsComponent from './components/ListUnderexcitationLimiterDynamicsComponent';
import CreateUnderexcitationLimiterDynamicsComponent from './components/CreateUnderexcitationLimiterDynamicsComponent';
import UpdateUnderexcitationLimiterDynamicsComponent from './components/UpdateUnderexcitationLimiterDynamicsComponent';
import ViewUnderexcitationLimiterDynamicsComponent from './components/ViewUnderexcitationLimiterDynamicsComponent';
...
import ListVoltageAdjusterDynamicsComponent from './components/ListVoltageAdjusterDynamicsComponent';
import CreateVoltageAdjusterDynamicsComponent from './components/CreateVoltageAdjusterDynamicsComponent';
import UpdateVoltageAdjusterDynamicsComponent from './components/UpdateVoltageAdjusterDynamicsComponent';
import ViewVoltageAdjusterDynamicsComponent from './components/ViewVoltageAdjusterDynamicsComponent';
...
import ListVoltageCompensatorDynamicsComponent from './components/ListVoltageCompensatorDynamicsComponent';
import CreateVoltageCompensatorDynamicsComponent from './components/CreateVoltageCompensatorDynamicsComponent';
import UpdateVoltageCompensatorDynamicsComponent from './components/UpdateVoltageCompensatorDynamicsComponent';
import ViewVoltageCompensatorDynamicsComponent from './components/ViewVoltageCompensatorDynamicsComponent';
...
import ListWindGenTurbineType1IECComponent from './components/ListWindGenTurbineType1IECComponent';
import CreateWindGenTurbineType1IECComponent from './components/CreateWindGenTurbineType1IECComponent';
import UpdateWindGenTurbineType1IECComponent from './components/UpdateWindGenTurbineType1IECComponent';
import ViewWindGenTurbineType1IECComponent from './components/ViewWindGenTurbineType1IECComponent';
import ListWindGenTurbineType2IECComponent from './components/ListWindGenTurbineType2IECComponent';
import CreateWindGenTurbineType2IECComponent from './components/CreateWindGenTurbineType2IECComponent';
import UpdateWindGenTurbineType2IECComponent from './components/UpdateWindGenTurbineType2IECComponent';
import ViewWindGenTurbineType2IECComponent from './components/ViewWindGenTurbineType2IECComponent';
...
import ListWindPlantDynamicsComponent from './components/ListWindPlantDynamicsComponent';
import CreateWindPlantDynamicsComponent from './components/CreateWindPlantDynamicsComponent';
import UpdateWindPlantDynamicsComponent from './components/UpdateWindPlantDynamicsComponent';
import ViewWindPlantDynamicsComponent from './components/ViewWindPlantDynamicsComponent';
...
import ListWindPlantIECComponent from './components/ListWindPlantIECComponent';
import CreateWindPlantIECComponent from './components/CreateWindPlantIECComponent';
import UpdateWindPlantIECComponent from './components/UpdateWindPlantIECComponent';
import ViewWindPlantIECComponent from './components/ViewWindPlantIECComponent';
...
import ListWindTurbineType1or2DynamicsComponent from './components/ListWindTurbineType1or2DynamicsComponent';
import CreateWindTurbineType1or2DynamicsComponent from './components/CreateWindTurbineType1or2DynamicsComponent';
import UpdateWindTurbineType1or2DynamicsComponent from './components/UpdateWindTurbineType1or2DynamicsComponent';
import ViewWindTurbineType1or2DynamicsComponent from './components/ViewWindTurbineType1or2DynamicsComponent';
import ListWindTurbineType1or2IECComponent from './components/ListWindTurbineType1or2IECComponent';
import CreateWindTurbineType1or2IECComponent from './components/CreateWindTurbineType1or2IECComponent';
import UpdateWindTurbineType1or2IECComponent from './components/UpdateWindTurbineType1or2IECComponent';
import ViewWindTurbineType1or2IECComponent from './components/ViewWindTurbineType1or2IECComponent';
import ListWindTurbineType3or4DynamicsComponent from './components/ListWindTurbineType3or4DynamicsComponent';
import CreateWindTurbineType3or4DynamicsComponent from './components/CreateWindTurbineType3or4DynamicsComponent';
import UpdateWindTurbineType3or4DynamicsComponent from './components/UpdateWindTurbineType3or4DynamicsComponent';
import ViewWindTurbineType3or4DynamicsComponent from './components/ViewWindTurbineType3or4DynamicsComponent';
import ListWindTurbineType3or4IECComponent from './components/ListWindTurbineType3or4IECComponent';
import CreateWindTurbineType3or4IECComponent from './components/CreateWindTurbineType3or4IECComponent';
import UpdateWindTurbineType3or4IECComponent from './components/UpdateWindTurbineType3or4IECComponent';
import ViewWindTurbineType3or4IECComponent from './components/ViewWindTurbineType3or4IECComponent';
import ListWindTurbineType4aIECComponent from './components/ListWindTurbineType4aIECComponent';
import CreateWindTurbineType4aIECComponent from './components/CreateWindTurbineType4aIECComponent';
import UpdateWindTurbineType4aIECComponent from './components/UpdateWindTurbineType4aIECComponent';
import ViewWindTurbineType4aIECComponent from './components/ViewWindTurbineType4aIECComponent';
import ListWindTurbineType4bIECComponent from './components/ListWindTurbineType4bIECComponent';
import CreateWindTurbineType4bIECComponent from './components/CreateWindTurbineType4bIECComponent';
import UpdateWindTurbineType4bIECComponent from './components/UpdateWindTurbineType4bIECComponent';
import ViewWindTurbineType4bIECComponent from './components/ViewWindTurbineType4bIECComponent';
                ...
                <div className="container">
                    <Switch>
                          ...
                          {/* <Route path = "/update-accumulatorLimit/:id" component = {UpdateAccumulatorLimitComponent}></Route> */}
                            <Route path = "/accumulatorLimitSets" component = {ListAccumulatorLimitSetComponent}></Route>
                            <Route path = "/add-accumulatorLimitSet/:id" component = {CreateAccumulatorLimitSetComponent}></Route>
                            <Route path = "/view-accumulatorLimitSet/:id" component = {ViewAccumulatorLimitSetComponent}></Route>
                          {/* <Route path = "/update-accumulatorLimitSet/:id" component = {UpdateAccumulatorLimitSetComponent}></Route> */}
                            <Route path = "/accumulatorResets" component = {ListAccumulatorResetComponent}></Route>
                            <Route path = "/add-accumulatorReset/:id" component = {CreateAccumulatorResetComponent}></Route>
                            <Route path = "/view-accumulatorReset/:id" component = {ViewAccumulatorResetComponent}></Route>
                          {/* <Route path = "/update-accumulatorReset/:id" component = {UpdateAccumulatorResetComponent}></Route> */}
                          ...
                          {/* <Route path = "/update-analogLimit/:id" component = {UpdateAnalogLimitComponent}></Route> */}
                            <Route path = "/analogLimitSets" component = {ListAnalogLimitSetComponent}></Route>
                            <Route path = "/add-analogLimitSet/:id" component = {CreateAnalogLimitSetComponent}></Route>
                            <Route path = "/view-analogLimitSet/:id" component = {ViewAnalogLimitSetComponent}></Route>
                          {/* <Route path = "/update-analogLimitSet/:id" component = {UpdateAnalogLimitSetComponent}></Route> */}
                          ...
                          {/* <Route path = "/update-asynchronousMachine/:id" component = {UpdateAsynchronousMachineComponent}></Route> */}
                            <Route path = "/asynchronousMachineDynamicss" component = {ListAsynchronousMachineDynamicsComponent}></Route>
                            <Route path = "/add-asynchronousMachineDynamics/:id" component = {CreateAsynchronousMachineDynamicsComponent}></Route>
                            <Route path = "/view-asynchronousMachineDynamics/:id" component = {ViewAsynchronousMachineDynamicsComponent}></Route>
                          {/* <Route path = "/update-asynchronousMachineDynamics/:id" component = {UpdateAsynchronousMachineDynamicsComponent}></Route> */}
                          ...
                          {/* <Route path = "/update-basicIntervalSchedule/:id" component = {UpdateBasicIntervalScheduleComponent}></Route> */}
                            <Route path = "/bays" component = {ListBayComponent}></Route>
                            <Route path = "/add-bay/:id" component = {CreateBayComponent}></Route>
                            <Route path = "/view-bay/:id" component = {ViewBayComponent}></Route>
                          {/* <Route path = "/update-bay/:id" component = {UpdateBayComponent}></Route> */}
                          ...
                          {/* <Route path = "/update-conductor/:id" component = {UpdateConductorComponent}></Route> */}
                            <Route path = "/conformLoads" component = {ListConformLoadComponent}></Route>
                            <Route path = "/add-conformLoad/:id" component = {CreateConformLoadComponent}></Route>
                            <Route path = "/view-conformLoad/:id" component = {ViewConformLoadComponent}></Route>
                          {/* <Route path = "/update-conformLoad/:id" component = {UpdateConformLoadComponent}></Route> */}
                            <Route path = "/conformLoadSchedules" component = {ListConformLoadScheduleComponent}></Route>
                            <Route path = "/add-conformLoadSchedule/:id" component = {CreateConformLoadScheduleComponent}></Route>
                            <Route path = "/view-conformLoadSchedule/:id" component = {ViewConformLoadScheduleComponent}></Route>
                          {/* <Route path = "/update-conformLoadSchedule/:id" component = {UpdateConformLoadScheduleComponent}></Route> */}
                          ...
                          {/* <Route path = "/update-controlArea/:id" component = {UpdateControlAreaComponent}></Route> */}
                            <Route path = "/controlAreaGeneratingUnits" component = {ListControlAreaGeneratingUnitComponent}></Route>
                            <Route path = "/add-controlAreaGeneratingUnit/:id" component = {CreateControlAreaGeneratingUnitComponent}></Route>
                            <Route path = "/view-controlAreaGeneratingUnit/:id" component = {ViewControlAreaGeneratingUnitComponent}></Route>
                          {/* <Route path = "/update-controlAreaGeneratingUnit/:id" component = {UpdateControlAreaGeneratingUnitComponent}></Route> */}
                          ...
                          {/* <Route path = "/update-curveData/:id" component = {UpdateCurveDataComponent}></Route> */}
                            <Route path = "/dCBaseTerminals" component = {ListDCBaseTerminalComponent}></Route>
                            <Route path = "/add-dCBaseTerminal/:id" component = {CreateDCBaseTerminalComponent}></Route>
                            <Route path = "/view-dCBaseTerminal/:id" component = {ViewDCBaseTerminalComponent}></Route>
                          {/* <Route path = "/update-dCBaseTerminal/:id" component = {UpdateDCBaseTerminalComponent}></Route> */}
                          ...
                          {/* <Route path = "/update-dCGround/:id" component = {UpdateDCGroundComponent}></Route> */}
                            <Route path = "/dCLines" component = {ListDCLineComponent}></Route>
                            <Route path = "/add-dCLine/:id" component = {CreateDCLineComponent}></Route>
                            <Route path = "/view-dCLine/:id" component = {ViewDCLineComponent}></Route>
                          {/* <Route path = "/update-dCLine/:id" component = {UpdateDCLineComponent}></Route> */}
                          ...
                          {/* <Route path = "/update-dCLineSegment/:id" component = {UpdateDCLineSegmentComponent}></Route> */}
                            <Route path = "/dCNodes" component = {ListDCNodeComponent}></Route>
                            <Route path = "/add-dCNode/:id" component = {CreateDCNodeComponent}></Route>
                            <Route path = "/view-dCNode/:id" component = {ViewDCNodeComponent}></Route>
                          {/* <Route path = "/update-dCNode/:id" component = {UpdateDCNodeComponent}></Route> */}
                          ...
                          {/* <Route path = "/update-dCShunt/:id" component = {UpdateDCShuntComponent}></Route> */}
                            <Route path = "/dCTerminals" component = {ListDCTerminalComponent}></Route>
                            <Route path = "/add-dCTerminal/:id" component = {CreateDCTerminalComponent}></Route>
                            <Route path = "/view-dCTerminal/:id" component = {ViewDCTerminalComponent}></Route>
                          {/* <Route path = "/update-dCTerminal/:id" component = {UpdateDCTerminalComponent}></Route> */}
                            <Route path = "/dCTopologicalIslands" component = {ListDCTopologicalIslandComponent}></Route>
                            <Route path = "/add-dCTopologicalIsland/:id" component = {CreateDCTopologicalIslandComponent}></Route>
                            <Route path = "/view-dCTopologicalIsland/:id" component = {ViewDCTopologicalIslandComponent}></Route>
                          {/* <Route path = "/update-dCTopologicalIsland/:id" component = {UpdateDCTopologicalIslandComponent}></Route> */}
                            <Route path = "/dCTopologicalNodes" component = {ListDCTopologicalNodeComponent}></Route>
                            <Route path = "/add-dCTopologicalNode/:id" component = {CreateDCTopologicalNodeComponent}></Route>
                            <Route path = "/view-dCTopologicalNode/:id" component = {ViewDCTopologicalNodeComponent}></Route>
                          {/* <Route path = "/update-dCTopologicalNode/:id" component = {UpdateDCTopologicalNodeComponent}></Route> */}
                          ...
                          {/* <Route path = "/update-discExcContIEEEDEC3A/:id" component = {UpdateDiscExcContIEEEDEC3AComponent}></Route> */}
                            <Route path = "/discontinuousExcitationControlDynamicss" component = {ListDiscontinuousExcitationControlDynamicsComponent}></Route>
                            <Route path = "/add-discontinuousExcitationControlDynamics/:id" component = {CreateDiscontinuousExcitationControlDynamicsComponent}></Route>
                            <Route path = "/view-discontinuousExcitationControlDynamics/:id" component = {ViewDiscontinuousExcitationControlDynamicsComponent}></Route>
                          {/* <Route path = "/update-discontinuousExcitationControlDynamics/:id" component = {UpdateDiscontinuousExcitationControlDynamicsComponent}></Route> */}
                          ...
                          {/* <Route path = "/update-discontinuousExcitationControlUserDefined/:id" component = {UpdateDiscontinuousExcitationControlUserDefinedComponent}></Route> */}
                            <Route path = "/discretes" component = {ListDiscreteComponent}></Route>
                            <Route path = "/add-discrete/:id" component = {CreateDiscreteComponent}></Route>
                            <Route path = "/view-discrete/:id" component = {ViewDiscreteComponent}></Route>
                          {/* <Route path = "/update-discrete/:id" component = {UpdateDiscreteComponent}></Route> */}
                          ...
                          {/* <Route path = "/update-energyConsumer/:id" component = {UpdateEnergyConsumerComponent}></Route> */}
                            <Route path = "/energySources" component = {ListEnergySourceComponent}></Route>
                            <Route path = "/add-energySource/:id" component = {CreateEnergySourceComponent}></Route>
                            <Route path = "/view-energySource/:id" component = {ViewEnergySourceComponent}></Route>
                          {/* <Route path = "/update-energySource/:id" component = {UpdateEnergySourceComponent}></Route> */}
                            <Route path = "/equipments" component = {ListEquipmentComponent}></Route>
                            <Route path = "/add-equipment/:id" component = {CreateEquipmentComponent}></Route>
                            <Route path = "/view-equipment/:id" component = {ViewEquipmentComponent}></Route>
                          {/* <Route path = "/update-equipment/:id" component = {UpdateEquipmentComponent}></Route> */}
                          ...
                          {/* <Route path = "/update-equivalentBranch/:id" component = {UpdateEquivalentBranchComponent}></Route> */}
                            <Route path = "/equivalentEquipments" component = {ListEquivalentEquipmentComponent}></Route>
                            <Route path = "/add-equivalentEquipment/:id" component = {CreateEquivalentEquipmentComponent}></Route>
                            <Route path = "/view-equivalentEquipment/:id" component = {ViewEquivalentEquipmentComponent}></Route>
                          {/* <Route path = "/update-equivalentEquipment/:id" component = {UpdateEquivalentEquipmentComponent}></Route> */}
                          ...
                          {/* <Route path = "/update-excST7B/:id" component = {UpdateExcST7BComponent}></Route> */}
                            <Route path = "/excitationSystemDynamicss" component = {ListExcitationSystemDynamicsComponent}></Route>
                            <Route path = "/add-excitationSystemDynamics/:id" component = {CreateExcitationSystemDynamicsComponent}></Route>
                            <Route path = "/view-excitationSystemDynamics/:id" component = {ViewExcitationSystemDynamicsComponent}></Route>
                          {/* <Route path = "/update-excitationSystemDynamics/:id" component = {UpdateExcitationSystemDynamicsComponent}></Route> */}
                          ...
                          {/* <Route path = "/update-govSteamSGO/:id" component = {UpdateGovSteamSGOComponent}></Route> */}
                            <Route path = "/grossToNetActivePowerCurves" component = {ListGrossToNetActivePowerCurveComponent}></Route>
                            <Route path = "/add-grossToNetActivePowerCurve/:id" component = {CreateGrossToNetActivePowerCurveComponent}></Route>
                            <Route path = "/view-grossToNetActivePowerCurve/:id" component = {ViewGrossToNetActivePowerCurveComponent}></Route>
                          {/* <Route path = "/update-grossToNetActivePowerCurve/:id" component = {UpdateGrossToNetActivePowerCurveComponent}></Route> */}
                          ...
                          {/* <Route path = "/update-hydroPowerPlant/:id" component = {UpdateHydroPowerPlantComponent}></Route> */}
                            <Route path = "/hydroPumps" component = {ListHydroPumpComponent}></Route>
                            <Route path = "/add-hydroPump/:id" component = {CreateHydroPumpComponent}></Route>
                            <Route path = "/view-hydroPump/:id" component = {ViewHydroPumpComponent}></Route>
                          {/* <Route path = "/update-hydroPump/:id" component = {UpdateHydroPumpComponent}></Route> */}
                          ...
                          {/* <Route path = "/update-limitSet/:id" component = {UpdateLimitSetComponent}></Route> */}
                            <Route path = "/lines" component = {ListLineComponent}></Route>
                            <Route path = "/add-line/:id" component = {CreateLineComponent}></Route>
                            <Route path = "/view-line/:id" component = {ViewLineComponent}></Route>
                          {/* <Route path = "/update-line/:id" component = {UpdateLineComponent}></Route> */}
                          ...
                          {/* <Route path = "/update-loadGenericNonLinear/:id" component = {UpdateLoadGenericNonLinearComponent}></Route> */}
                            <Route path = "/loadGroups" component = {ListLoadGroupComponent}></Route>
                            <Route path = "/add-loadGroup/:id" component = {CreateLoadGroupComponent}></Route>
                            <Route path = "/view-loadGroup/:id" component = {ViewLoadGroupComponent}></Route>
                          {/* <Route path = "/update-loadGroup/:id" component = {UpdateLoadGroupComponent}></Route> */}
                          ...
                          {/* <Route path = "/update-measurementValue/:id" component = {UpdateMeasurementValueComponent}></Route> */}
                            <Route path = "/measurementValueQualitys" component = {ListMeasurementValueQualityComponent}></Route>
                            <Route path = "/add-measurementValueQuality/:id" component = {CreateMeasurementValueQualityComponent}></Route>
                            <Route path = "/view-measurementValueQuality/:id" component = {ViewMeasurementValueQualityComponent}></Route>
                          {/* <Route path = "/update-measurementValueQuality/:id" component = {UpdateMeasurementValueQualityComponent}></Route> */}
                          ...
                          {/* <Route path = "/update-mechLoad1/:id" component = {UpdateMechLoad1Component}></Route> */}
                            <Route path = "/mechanicalLoadDynamicss" component = {ListMechanicalLoadDynamicsComponent}></Route>
                            <Route path = "/add-mechanicalLoadDynamics/:id" component = {CreateMechanicalLoadDynamicsComponent}></Route>
                            <Route path = "/view-mechanicalLoadDynamics/:id" component = {ViewMechanicalLoadDynamicsComponent}></Route>
                          {/* <Route path = "/update-mechanicalLoadDynamics/:id" component = {UpdateMechanicalLoadDynamicsComponent}></Route> */}
                          ...
                          {/* <Route path = "/update-mutualCoupling/:id" component = {UpdateMutualCouplingComponent}></Route> */}
                            <Route path = "/nonConformLoads" component = {ListNonConformLoadComponent}></Route>
                            <Route path = "/add-nonConformLoad/:id" component = {CreateNonConformLoadComponent}></Route>
                            <Route path = "/view-nonConformLoad/:id" component = {ViewNonConformLoadComponent}></Route>
                          {/* <Route path = "/update-nonConformLoad/:id" component = {UpdateNonConformLoadComponent}></Route> */}
                            <Route path = "/nonConformLoadSchedules" component = {ListNonConformLoadScheduleComponent}></Route>
                            <Route path = "/add-nonConformLoadSchedule/:id" component = {CreateNonConformLoadScheduleComponent}></Route>
                            <Route path = "/view-nonConformLoadSchedule/:id" component = {ViewNonConformLoadScheduleComponent}></Route>
                          {/* <Route path = "/update-nonConformLoadSchedule/:id" component = {UpdateNonConformLoadScheduleComponent}></Route> */}
                          ...
                          {/* <Route path = "/update-nonlinearShuntCompensatorPoint/:id" component = {UpdateNonlinearShuntCompensatorPointComponent}></Route> */}
                            <Route path = "/operationalLimits" component = {ListOperationalLimitComponent}></Route>
                            <Route path = "/add-operationalLimit/:id" component = {CreateOperationalLimitComponent}></Route>
                            <Route path = "/view-operationalLimit/:id" component = {ViewOperationalLimitComponent}></Route>
                          {/* <Route path = "/update-operationalLimit/:id" component = {UpdateOperationalLimitComponent}></Route> */}
                            <Route path = "/operationalLimitSets" component = {ListOperationalLimitSetComponent}></Route>
                            <Route path = "/add-operationalLimitSet/:id" component = {CreateOperationalLimitSetComponent}></Route>
                            <Route path = "/view-operationalLimitSet/:id" component = {ViewOperationalLimitSetComponent}></Route>
                          {/* <Route path = "/update-operationalLimitSet/:id" component = {UpdateOperationalLimitSetComponent}></Route> */}
                          ...
                          {/* <Route path = "/update-overexcLimX2/:id" component = {UpdateOverexcLimX2Component}></Route> */}
                            <Route path = "/overexcitationLimiterDynamicss" component = {ListOverexcitationLimiterDynamicsComponent}></Route>
                            <Route path = "/add-overexcitationLimiterDynamics/:id" component = {CreateOverexcitationLimiterDynamicsComponent}></Route>
                            <Route path = "/view-overexcitationLimiterDynamics/:id" component = {ViewOverexcitationLimiterDynamicsComponent}></Route>
                          {/* <Route path = "/update-overexcitationLimiterDynamics/:id" component = {UpdateOverexcitationLimiterDynamicsComponent}></Route> */}
                          ...
                          {/* <Route path = "/update-overexcitationLimiterUserDefined/:id" component = {UpdateOverexcitationLimiterUserDefinedComponent}></Route> */}
                            <Route path = "/pFVArControllerType1Dynamicss" component = {ListPFVArControllerType1DynamicsComponent}></Route>
                            <Route path = "/add-pFVArControllerType1Dynamics/:id" component = {CreatePFVArControllerType1DynamicsComponent}></Route>
                            <Route path = "/view-pFVArControllerType1Dynamics/:id" component = {ViewPFVArControllerType1DynamicsComponent}></Route>
                          {/* <Route path = "/update-pFVArControllerType1Dynamics/:id" component = {UpdatePFVArControllerType1DynamicsComponent}></Route> */}
                          ...
                          {/* <Route path = "/update-pFVArControllerType1UserDefined/:id" component = {UpdatePFVArControllerType1UserDefinedComponent}></Route> */}
                            <Route path = "/pFVArControllerType2Dynamicss" component = {ListPFVArControllerType2DynamicsComponent}></Route>
                            <Route path = "/add-pFVArControllerType2Dynamics/:id" component = {CreatePFVArControllerType2DynamicsComponent}></Route>
                            <Route path = "/view-pFVArControllerType2Dynamics/:id" component = {ViewPFVArControllerType2DynamicsComponent}></Route>
                          {/* <Route path = "/update-pFVArControllerType2Dynamics/:id" component = {UpdatePFVArControllerType2DynamicsComponent}></Route> */}
                          ...
                          {/* <Route path = "/update-petersenCoil/:id" component = {UpdatePetersenCoilComponent}></Route> */}
                            <Route path = "/phaseTapChangers" component = {ListPhaseTapChangerComponent}></Route>
                            <Route path = "/add-phaseTapChanger/:id" component = {CreatePhaseTapChangerComponent}></Route>
                            <Route path = "/view-phaseTapChanger/:id" component = {ViewPhaseTapChangerComponent}></Route>
                          {/* <Route path = "/update-phaseTapChanger/:id" component = {UpdatePhaseTapChangerComponent}></Route> */}
                          ...
                          {/* <Route path = "/update-phaseTapChangerTablePoint/:id" component = {UpdatePhaseTapChangerTablePointComponent}></Route> */}
                            <Route path = "/phaseTapChangerTabulars" component = {ListPhaseTapChangerTabularComponent}></Route>
                            <Route path = "/add-phaseTapChangerTabular/:id" component = {CreatePhaseTapChangerTabularComponent}></Route>
                            <Route path = "/view-phaseTapChangerTabular/:id" component = {ViewPhaseTapChangerTabularComponent}></Route>
                          {/* <Route path = "/update-phaseTapChangerTabular/:id" component = {UpdatePhaseTapChangerTabularComponent}></Route> */}
                          ...
                          {/* <Route path = "/update-positionPoint/:id" component = {UpdatePositionPointComponent}></Route> */}
                            <Route path = "/powerSystemStabilizerDynamicss" component = {ListPowerSystemStabilizerDynamicsComponent}></Route>
                            <Route path = "/add-powerSystemStabilizerDynamics/:id" component = {CreatePowerSystemStabilizerDynamicsComponent}></Route>
                            <Route path = "/view-powerSystemStabilizerDynamics/:id" component = {ViewPowerSystemStabilizerDynamicsComponent}></Route>
                          {/* <Route path = "/update-powerSystemStabilizerDynamics/:id" component = {UpdatePowerSystemStabilizerDynamicsComponent}></Route> */}
                          ...
                          {/* <Route path = "/update-quality61850/:id" component = {UpdateQuality61850Component}></Route> */}
                            <Route path = "/raiseLowerCommands" component = {ListRaiseLowerCommandComponent}></Route>
                            <Route path = "/add-raiseLowerCommand/:id" component = {CreateRaiseLowerCommandComponent}></Route>
                            <Route path = "/view-raiseLowerCommand/:id" component = {ViewRaiseLowerCommandComponent}></Route>
                          {/* <Route path = "/update-raiseLowerCommand/:id" component = {UpdateRaiseLowerCommandComponent}></Route> */}
                          ...
                          {/* <Route path = "/update-ratioTapChanger/:id" component = {UpdateRatioTapChangerComponent}></Route> */}
                            <Route path = "/ratioTapChangerTablePoints" component = {ListRatioTapChangerTablePointComponent}></Route>
                            <Route path = "/add-ratioTapChangerTablePoint/:id" component = {CreateRatioTapChangerTablePointComponent}></Route>
                            <Route path = "/view-ratioTapChangerTablePoint/:id" component = {ViewRatioTapChangerTablePointComponent}></Route>
                          {/* <Route path = "/update-ratioTapChangerTablePoint/:id" component = {UpdateRatioTapChangerTablePointComponent}></Route> */}
                          ...
                          {/* <Route path = "/update-regularTimePoint/:id" component = {UpdateRegularTimePointComponent}></Route> */}
                            <Route path = "/regulatingCondEqs" component = {ListRegulatingCondEqComponent}></Route>
                            <Route path = "/add-regulatingCondEq/:id" component = {CreateRegulatingCondEqComponent}></Route>
                            <Route path = "/view-regulatingCondEq/:id" component = {ViewRegulatingCondEqComponent}></Route>
                          {/* <Route path = "/update-regulatingCondEq/:id" component = {UpdateRegulatingCondEqComponent}></Route> */}
                          ...
                          {/* <Route path = "/update-regulatingControl/:id" component = {UpdateRegulatingControlComponent}></Route> */}
                            <Route path = "/regulationSchedules" component = {ListRegulationScheduleComponent}></Route>
                            <Route path = "/add-regulationSchedule/:id" component = {CreateRegulationScheduleComponent}></Route>
                            <Route path = "/view-regulationSchedule/:id" component = {ViewRegulationScheduleComponent}></Route>
                          {/* <Route path = "/update-regulationSchedule/:id" component = {UpdateRegulationScheduleComponent}></Route> */}
                          ...
                          {/* <Route path = "/update-season/:id" component = {UpdateSeasonComponent}></Route> */}
                            <Route path = "/seasonDayTypeSchedules" component = {ListSeasonDayTypeScheduleComponent}></Route>
                            <Route path = "/add-seasonDayTypeSchedule/:id" component = {CreateSeasonDayTypeScheduleComponent}></Route>
                            <Route path = "/view-seasonDayTypeSchedule/:id" component = {ViewSeasonDayTypeScheduleComponent}></Route>
                          {/* <Route path = "/update-seasonDayTypeSchedule/:id" component = {UpdateSeasonDayTypeScheduleComponent}></Route> */}
                          ...
                          {/* <Route path = "/update-stringMeasurementValue/:id" component = {UpdateStringMeasurementValueComponent}></Route> */}
                            <Route path = "/subGeographicalRegions" component = {ListSubGeographicalRegionComponent}></Route>
                            <Route path = "/add-subGeographicalRegion/:id" component = {CreateSubGeographicalRegionComponent}></Route>
                            <Route path = "/view-subGeographicalRegion/:id" component = {ViewSubGeographicalRegionComponent}></Route>
                          {/* <Route path = "/update-subGeographicalRegion/:id" component = {UpdateSubGeographicalRegionComponent}></Route> */}
                            <Route path = "/subLoadAreas" component = {ListSubLoadAreaComponent}></Route>
                            <Route path = "/add-subLoadArea/:id" component = {CreateSubLoadAreaComponent}></Route>
                            <Route path = "/view-subLoadArea/:id" component = {ViewSubLoadAreaComponent}></Route>
                          {/* <Route path = "/update-subLoadArea/:id" component = {UpdateSubLoadAreaComponent}></Route> */}
                            <Route path = "/substations" component = {ListSubstationComponent}></Route>
                            <Route path = "/add-substation/:id" component = {CreateSubstationComponent}></Route>
                            <Route path = "/view-substation/:id" component = {ViewSubstationComponent}></Route>
                          {/* <Route path = "/update-substation/:id" component = {UpdateSubstationComponent}></Route> */}
                          ...
                          {/* <Route path = "/update-switchProxy/:id" component = {UpdateSwitchProxyComponent}></Route> */}
                            <Route path = "/switchSchedules" component = {ListSwitchScheduleComponent}></Route>
                            <Route path = "/add-switchSchedule/:id" component = {CreateSwitchScheduleComponent}></Route>
                            <Route path = "/view-switchSchedule/:id" component = {ViewSwitchScheduleComponent}></Route>
                          {/* <Route path = "/update-switchSchedule/:id" component = {UpdateSwitchScheduleComponent}></Route> */}
                          ...
                          {/* <Route path = "/update-synchronousMachineDetailed/:id" component = {UpdateSynchronousMachineDetailedComponent}></Route> */}
                            <Route path = "/synchronousMachineDynamicss" component = {ListSynchronousMachineDynamicsComponent}></Route>
                            <Route path = "/add-synchronousMachineDynamics/:id" component = {CreateSynchronousMachineDynamicsComponent}></Route>
                            <Route path = "/view-synchronousMachineDynamics/:id" component = {ViewSynchronousMachineDynamicsComponent}></Route>
                          {/* <Route path = "/update-synchronousMachineDynamics/:id" component = {UpdateSynchronousMachineDynamicsComponent}></Route> */}
                          ...
                          {/* <Route path = "/update-tapChangerTablePoint/:id" component = {UpdateTapChangerTablePointComponent}></Route> */}
                            <Route path = "/tapSchedules" component = {ListTapScheduleComponent}></Route>
                            <Route path = "/add-tapSchedule/:id" component = {CreateTapScheduleComponent}></Route>
                            <Route path = "/view-tapSchedule/:id" component = {ViewTapScheduleComponent}></Route>
                          {/* <Route path = "/update-tapSchedule/:id" component = {UpdateTapScheduleComponent}></Route> */}
                          ...
                          {/* <Route path = "/update-tieFlow/:id" component = {UpdateTieFlowComponent}></Route> */}
                            <Route path = "/topologicalIslands" component = {ListTopologicalIslandComponent}></Route>
                            <Route path = "/add-topologicalIsland/:id" component = {CreateTopologicalIslandComponent}></Route>
                            <Route path = "/view-topologicalIsland/:id" component = {ViewTopologicalIslandComponent}></Route>
                          {/* <Route path = "/update-topologicalIsland/:id" component = {UpdateTopologicalIslandComponent}></Route> */}
                          ...
                          {/* <Route path = "/update-turbLCFB1/:id" component = {UpdateTurbLCFB1Component}></Route> */}
                            <Route path = "/turbineGovernorDynamicss" component = {ListTurbineGovernorDynamicsComponent}></Route>
                            <Route path = "/add-turbineGovernorDynamics/:id" component = {CreateTurbineGovernorDynamicsComponent}></Route>
                            <Route path = "/view-turbineGovernorDynamics/:id" component = {ViewTurbineGovernorDynamicsComponent}></Route>
                          {/* <Route path = "/update-turbineGovernorDynamics/:id" component = {UpdateTurbineGovernorDynamicsComponent}></Route> */}
                          ...
                          {/* <Route path = "/update-turbineGovernorUserDefined/:id" component = {UpdateTurbineGovernorUserDefinedComponent}></Route> */}
                            <Route path = "/turbineLoadControllerDynamicss" component = {ListTurbineLoadControllerDynamicsComponent}></Route>
                            <Route path = "/add-turbineLoadControllerDynamics/:id" component = {CreateTurbineLoadControllerDynamicsComponent}></Route>
                            <Route path = "/view-turbineLoadControllerDynamics/:id" component = {ViewTurbineLoadControllerDynamicsComponent}></Route>
                          {/* <Route path = "/update-turbineLoadControllerDynamics/:id" component = {UpdateTurbineLoadControllerDynamicsComponent}></Route> */}
                          ...
                          {/* <Route path = "/update-underexcLimX2/:id" component = {UpdateUnderexcLimX2Component}></Route> */}
                            <Route path = "/underexcitationLimiterDynamicss" component = {ListUnderexcitationLimiterDynamicsComponent}></Route>
                            <Route path = "/add-underexcitationLimiterDynamics/:id" component = {CreateUnderexcitationLimiterDynamicsComponent}></Route>
                            <Route path = "/view-underexcitationLimiterDynamics/:id" component = {ViewUnderexcitationLimiterDynamicsComponent}></Route>
                          {/* <Route path = "/update-underexcitationLimiterDynamics/:id" component = {UpdateUnderexcitationLimiterDynamicsComponent}></Route> */}
                          ...
                          {/* <Route path = "/update-voltage/:id" component = {UpdateVoltageComponent}></Route> */}
                            <Route path = "/voltageAdjusterDynamicss" component = {ListVoltageAdjusterDynamicsComponent}></Route>
                            <Route path = "/add-voltageAdjusterDynamics/:id" component = {CreateVoltageAdjusterDynamicsComponent}></Route>
                            <Route path = "/view-voltageAdjusterDynamics/:id" component = {ViewVoltageAdjusterDynamicsComponent}></Route>
                          {/* <Route path = "/update-voltageAdjusterDynamics/:id" component = {UpdateVoltageAdjusterDynamicsComponent}></Route> */}
                          ...
                          {/* <Route path = "/update-voltageAdjusterUserDefined/:id" component = {UpdateVoltageAdjusterUserDefinedComponent}></Route> */}
                            <Route path = "/voltageCompensatorDynamicss" component = {ListVoltageCompensatorDynamicsComponent}></Route>
                            <Route path = "/add-voltageCompensatorDynamics/:id" component = {CreateVoltageCompensatorDynamicsComponent}></Route>
                            <Route path = "/view-voltageCompensatorDynamics/:id" component = {ViewVoltageCompensatorDynamicsComponent}></Route>
                          {/* <Route path = "/update-voltageCompensatorDynamics/:id" component = {UpdateVoltageCompensatorDynamicsComponent}></Route> */}
                          ...
                          {/* <Route path = "/update-windDynamicsLookupTable/:id" component = {UpdateWindDynamicsLookupTableComponent}></Route> */}
                            <Route path = "/windGenTurbineType1IECs" component = {ListWindGenTurbineType1IECComponent}></Route>
                            <Route path = "/add-windGenTurbineType1IEC/:id" component = {CreateWindGenTurbineType1IECComponent}></Route>
                            <Route path = "/view-windGenTurbineType1IEC/:id" component = {ViewWindGenTurbineType1IECComponent}></Route>
                          {/* <Route path = "/update-windGenTurbineType1IEC/:id" component = {UpdateWindGenTurbineType1IECComponent}></Route> */}
                            <Route path = "/windGenTurbineType2IECs" component = {ListWindGenTurbineType2IECComponent}></Route>
                            <Route path = "/add-windGenTurbineType2IEC/:id" component = {CreateWindGenTurbineType2IECComponent}></Route>
                            <Route path = "/view-windGenTurbineType2IEC/:id" component = {ViewWindGenTurbineType2IECComponent}></Route>
                          {/* <Route path = "/update-windGenTurbineType2IEC/:id" component = {UpdateWindGenTurbineType2IECComponent}></Route> */}
                          ...
                          {/* <Route path = "/update-windPitchContEmulIEC/:id" component = {UpdateWindPitchContEmulIECComponent}></Route> */}
                            <Route path = "/windPlantDynamicss" component = {ListWindPlantDynamicsComponent}></Route>
                            <Route path = "/add-windPlantDynamics/:id" component = {CreateWindPlantDynamicsComponent}></Route>
                            <Route path = "/view-windPlantDynamics/:id" component = {ViewWindPlantDynamicsComponent}></Route>
                          {/* <Route path = "/update-windPlantDynamics/:id" component = {UpdateWindPlantDynamicsComponent}></Route> */}
                          ...
                          {/* <Route path = "/update-windPlantFreqPcontrolIEC/:id" component = {UpdateWindPlantFreqPcontrolIECComponent}></Route> */}
                            <Route path = "/windPlantIECs" component = {ListWindPlantIECComponent}></Route>
                            <Route path = "/add-windPlantIEC/:id" component = {CreateWindPlantIECComponent}></Route>
                            <Route path = "/view-windPlantIEC/:id" component = {ViewWindPlantIECComponent}></Route>
                          {/* <Route path = "/update-windPlantIEC/:id" component = {UpdateWindPlantIECComponent}></Route> */}
                          ...
                          {/* <Route path = "/update-windProtectionIEC/:id" component = {UpdateWindProtectionIECComponent}></Route> */}
                            <Route path = "/windTurbineType1or2Dynamicss" component = {ListWindTurbineType1or2DynamicsComponent}></Route>
                            <Route path = "/add-windTurbineType1or2Dynamics/:id" component = {CreateWindTurbineType1or2DynamicsComponent}></Route>
                            <Route path = "/view-windTurbineType1or2Dynamics/:id" component = {ViewWindTurbineType1or2DynamicsComponent}></Route>
                          {/* <Route path = "/update-windTurbineType1or2Dynamics/:id" component = {UpdateWindTurbineType1or2DynamicsComponent}></Route> */}
                            <Route path = "/windTurbineType1or2IECs" component = {ListWindTurbineType1or2IECComponent}></Route>
                            <Route path = "/add-windTurbineType1or2IEC/:id" component = {CreateWindTurbineType1or2IECComponent}></Route>
                            <Route path = "/view-windTurbineType1or2IEC/:id" component = {ViewWindTurbineType1or2IECComponent}></Route>
                          {/* <Route path = "/update-windTurbineType1or2IEC/:id" component = {UpdateWindTurbineType1or2IECComponent}></Route> */}
                            <Route path = "/windTurbineType3or4Dynamicss" component = {ListWindTurbineType3or4DynamicsComponent}></Route>
                            <Route path = "/add-windTurbineType3or4Dynamics/:id" component = {CreateWindTurbineType3or4DynamicsComponent}></Route>
                            <Route path = "/view-windTurbineType3or4Dynamics/:id" component = {ViewWindTurbineType3or4DynamicsComponent}></Route>
                          {/* <Route path = "/update-windTurbineType3or4Dynamics/:id" component = {UpdateWindTurbineType3or4DynamicsComponent}></Route> */}
                            <Route path = "/windTurbineType3or4IECs" component = {ListWindTurbineType3or4IECComponent}></Route>
                            <Route path = "/add-windTurbineType3or4IEC/:id" component = {CreateWindTurbineType3or4IECComponent}></Route>
                            <Route path = "/view-windTurbineType3or4IEC/:id" component = {ViewWindTurbineType3or4IECComponent}></Route>
                          {/* <Route path = "/update-windTurbineType3or4IEC/:id" component = {UpdateWindTurbineType3or4IECComponent}></Route> */}
                            <Route path = "/windTurbineType4aIECs" component = {ListWindTurbineType4aIECComponent}></Route>
                            <Route path = "/add-windTurbineType4aIEC/:id" component = {CreateWindTurbineType4aIECComponent}></Route>
                            <Route path = "/view-windTurbineType4aIEC/:id" component = {ViewWindTurbineType4aIECComponent}></Route>
                          {/* <Route path = "/update-windTurbineType4aIEC/:id" component = {UpdateWindTurbineType4aIECComponent}></Route> */}
                            <Route path = "/windTurbineType4bIECs" component = {ListWindTurbineType4bIECComponent}></Route>
                            <Route path = "/add-windTurbineType4bIEC/:id" component = {CreateWindTurbineType4bIECComponent}></Route>
                            <Route path = "/view-windTurbineType4bIEC/:id" component = {ViewWindTurbineType4bIECComponent}></Route>
                          {/* <Route path = "/update-windTurbineType4bIEC/:id" component = {UpdateWindTurbineType4bIECComponent}></Route> */}
